 ...
 *       &lt;sequence&gt;
 *         &lt;element name="usuario" type="{http://www.cibertec.edu.pe/ws/objects}usuariows" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetUsuariosResponse {
    ...
    protected List<Usuariows> usuario;
     ...
     * 
     */
    public List<Usuariows> getUsuario() {
        if (usuario == null) {
            usuario = new ArrayList<Usuariows>();
        }
        return this.usuario;
    }
